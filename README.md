...
**Last verified:** 2026-09-22 · **Resources:** 253 · **Categories:** 11
...
- [LangChain.js TypeSafe integration](https://github.com/langchain-ai/langchainjs/tree/main/libs/providers/langchain-typesafe) - This package contains the LangChain.js integration for TypeSafe System One models.
...
- [Jevonian](https://github.com/xinyao27/jevonian) - Local OpenAI/Anthropic/Responses-compatible proxy for coding agents where one Jev call answers both the model route and the thinking level for the virtual model `jevonian/auto`, after code has filtered candidates by protocol, context window, effort floor, and spent quota windows; a pinned model ID or explicit `jevonian/<route>` skips Jev entirely, and every turn is recorded with the serving model, the reason, real token usage, cache reads, and an estimated cost. [Jev channels](https://github.com/xinyao27/jevonian/blob/main/src/brain.ts) and [routing](https://github.com/xinyao27/jevonian/blob/main/src/routing.ts).
...
- [TipTour](https://github.com/milind-soni/tiptour-macos) - Open-Source fast local computer use.
...
- [Awesome Jev by TypeSafe](https://github.com/valentynkit/awesome-jev-typesafe) - Typed decisions with TypeSafe's Jev, the first System One model.
